...
class DepthFirst:
    """
    A Depth First algorithm that builds a stack of models with a unique assignment of activities for each instance.
    """

    def __init__(self, model: Model) -> None:
        self.model: Model = model.copy()
        self.states: list = []
        self.best_solution: Model = None
    ...
    def build_children(self, model: Model) -> None:
        """
